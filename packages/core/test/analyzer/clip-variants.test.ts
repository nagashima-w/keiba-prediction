 ...
 *  - 対照(default)は幅0.10・版文字列"2026-07-19.3"(build-prompt.ts の既存PROMPT_VERSIONと同一)。
 *  - 新版(wide15)は幅0.15(絶対値)・対照と異なる版文字列。
...
describe("CLIP_VARIANTS(クリップ幅の版registry)", () => {
  it("対照(default)は幅0.10・版文字列が既存PROMPT_VERSIONと同一の2026-07-19.3であること", () => {
    expect(CLIP_VARIANTS.default.id).toBe("default");
    expect(CLIP_VARIANTS.default.maxAdjust).toBe(0.1);
    expect(CLIP_VARIANTS.default.promptVersion).toBe("2026-07-19.3");
  });
