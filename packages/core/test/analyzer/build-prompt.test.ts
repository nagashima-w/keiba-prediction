...
describe("PROMPT_VERSION(プロンプト版番号、Task#27)", () => {
  ...
  it("展開想定強化版として 2026-07-18.1 が付与されていること", () => {
    expect(PROMPT_VERSION).toBe("2026-07-18.1");
  });
});
