...
export const CLIP_VARIANTS: Readonly<Record<ClipVariantId, ClipVariant>> = {
  default: {
    id: "default",
    maxAdjust: 0.1,
    // build-prompt.ts の PROMPT_VERSION と同一の値を手動同期する(#7で追随)。
    promptVersion: "2026-07-23.3",
  },
  wide15: {
    id: "wide15",
    maxAdjust: 0.15,
    // 対照(default)のPROMPT_VERSIONに"-clip015"を付けた値。対照更新時は必ず追随する(#7で追随)。
    promptVersion: "2026-07-23.3-clip015",
  },
};
